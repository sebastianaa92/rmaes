...
Tarea: 1. Hacer un diagrama de tortas y un barplot con la variable cualitativa elegida
...
```
 ...
 2. Hacer un histograma de frecuencia y un boxplot de una variable cuantitativa que encuentre en el dataset "Muestra"
